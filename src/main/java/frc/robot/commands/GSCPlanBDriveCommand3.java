...
public class GSCPlanBDriveCommand3 extends CommandBase {
  ...
  public GSCPlanBDriveCommand3(DrivetrainSubsystem drivetrainSubsystem, GyroSubsystem gyroSubsystem, IntakeSubsystem intakeSubsystem, BallManipulatorSubsystem ballManipulatorSubsystem) {
  ...
  public void execute() {
    ...
    if(encoderCount < 340000){
      m_drivetrainSubsystem.motorAngle(1,0);
    }else{
      finished = true;
    }
  }
