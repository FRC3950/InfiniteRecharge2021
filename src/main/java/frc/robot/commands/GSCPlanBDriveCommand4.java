...
public class GSCPlanBDriveCommand4 extends CommandBase {
  ...
  public GSCPlanBDriveCommand4(DrivetrainSubsystem drivetrainSubsystem, GyroSubsystem gyroSubsystem, IntakeSubsystem intakeSubsystem, BallManipulatorSubsystem ballManipulatorSubsystem) {
  ...
  public void execute() {
    ...
    m_ballManipulatorSubsystem.setConveyorMotor(-.8);
      ...
      if(m_gyroSubsystem.getYawAngle() < 30 && m_gyroSubsystem.getYawAngle() > 26){
        finished = true;
        count++;
      }else{
