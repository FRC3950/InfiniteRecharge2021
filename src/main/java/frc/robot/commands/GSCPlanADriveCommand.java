...
public class GSCPlanADriveCommand extends CommandBase {
  ...
  public GSCPlanADriveCommand(DrivetrainSubsystem drivetrainSubsystem, GyroSubsystem gyroSubsystem, IntakeSubsystem intakeSubsystem, BallManipulatorSubsystem ballManipulatorSubsystem) {
  ...
  @Override
  public void execute() {
    if(encoderCount > 149000){
      finished = true;
      System.out.println("true");
    }
    if(encoderCount < 150000){ //Between two squares ~80000
      m_drivetrainSubsystem.motorSpeed(.5);
      encoderCount = m_drivetrainSubsystem.getEncoderCount();
