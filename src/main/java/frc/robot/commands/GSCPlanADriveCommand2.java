...
public class GSCPlanADriveCommand2 extends CommandBase {
  ...
  public GSCPlanADriveCommand2(DrivetrainSubsystem drivetrainSubsystem, GyroSubsystem gyroSubsystem, IntakeSubsystem intakeSubsystem, BallManipulatorSubsystem ballManipulatorSubsystem) {
  ...
  public void execute() {
    ...
    if(redOrBlue == false){
      ...
      if(m_gyroSubsystem.getYawAngle() > -20 && m_gyroSubsystem.getYawAngle() < -16 && count == 0){
