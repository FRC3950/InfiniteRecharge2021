...
public class GSCPlanADriveCommand4 extends CommandBase {
  ...
  public GSCPlanADriveCommand4(DrivetrainSubsystem drivetrainSubsystem, GyroSubsystem gyroSubsystem, IntakeSubsystem intakeSubsystem, BallManipulatorSubsystem ballManipulatorSubsystem) {
  ...
  public void execute() {
    ...
    m_intakeSubsystem.setSingulatorMotor(1);
      if(m_gyroSubsystem.getYawAngle() < 69 && m_gyroSubsystem.getYawAngle() > 65){
        finished = true;
        count++;
      }else{
