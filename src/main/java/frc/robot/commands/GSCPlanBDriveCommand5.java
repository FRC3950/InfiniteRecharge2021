...
public class GSCPlanBDriveCommand5 extends CommandBase {
  ...
  public GSCPlanBDriveCommand5(DrivetrainSubsystem drivetrainSubsystem, GyroSubsystem gyroSubsystem, IntakeSubsystem intakeSubsystem, BallManipulatorSubsystem ballManipulatorSubsystem) {
