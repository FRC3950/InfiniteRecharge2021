...
public class GSCPlanBDriveCommand6 extends CommandBase {
  ...
  public GSCPlanBDriveCommand6(DrivetrainSubsystem drivetrainSubsystem, GyroSubsystem gyroSubsystem, IntakeSubsystem intakeSubsystem, BallManipulatorSubsystem ballManipulatorSubsystem) {
  ...
  public void execute() {
    ...
    m_intakeSubsystem.setSingulatorMotor(1);
      if(m_gyroSubsystem.getYawAngle() > -5 && m_gyroSubsystem.getYawAngle() < 5){
        finished = true;
      }else{
